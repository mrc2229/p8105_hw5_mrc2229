...
* The plot of the effect_power data shos that as the effect size increases, as does the power. The values of the betas (effect size) were directly related to the proportion of the time the null was rejected, or power, in an S shaped curve.
...
* The mean estimated betas across all samples appears to almost exactly match the true values based on this plot, though both mean estimates follow the same general trend of the true betas. The mean estimated betas only for samples where the null was rejected tends to be higher than the true beta, except when the true beta equals zero and particularly when the value of the beta is between 1 and 4.
